...
9 themes: AI & Infrastructure | AI Picks & Shovels | Space & Satellite Economy | Nuclear & Next-Gen Energy | Biotech & Longevity | Robotics & Automation | Cyber & Defence Tech | Oil, Gas & Energy Geopolitics | Geopolitical Momentum & Critical Minerals
Macro (March 2026): Hormuz crisis, Agentic AI compute boom, petrodollar stress.
For matching headlines return ONLY JSON array:
[{"headline":"...","source":"...","theme":"exact name","second_order":"one sentence","signal_strength":"HIGH"|"MEDIUM"|"LOW","tickers":["TICK1"],"watchlist_add":[{"ticker":"TICK","reason":"one sentence"}],"action":"one sentence"}]
